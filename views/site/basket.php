...
$this->registerCssFile('@web/css/basket.css',['depends' =>'app\assets\AppAsset']);
$this->registerCssFile('@web/css/select.css',['depends' =>'app\assets\AppAsset']);
$this->registerJsFile('@web/js/select.js',['depends' =>'app\assets\AppAsset']);
$this->registerJsFile('@web/js/basket.js',['depends' =>'app\assets\AppAsset']);
$this->title = 'Корзина';
?>
<div class="wrapper">
            ...
            <div class="row between-md">
                <div class="col-md-7 col-sm-7 col-xs-12">
                    <div class="products_wrp">
                        <div class="products_wrp__header">
                            <h3>Корзина</h3>
                            <a href="#" class="">
                        ...
                        foreach ($cake as $key=>$cak) {
                            if ($cak['id']){
                                $cake_a = \app\models\Assortment::find()->where(['id'=>$cak['id']])->one();
                                ?>
                                <div class="products_wrp__prod-list">
                                    <div class="position__header">
                                        <a href="#" class="header__close" id="<?=$key?>">
                                    ...
                                    <div class="prod-list__position">
                                        <div class="position__image"
                                             style="background: url(/web<?=$cake_a->img?>) no-repeat center;background-color: #F7F7F7;-webkit-background-size: cover;-moz-background-size: cover;background-size: cover;-o-background-size: cover;"></div>
                                        <div class="position__info">
                                            <div class="info__header">
                                                <h4><?=$cake_a->title?></h4>
                                            </div>
                                            <div class="info__control-sum">
                                                <span>Количество:</span>
                                                <select class="white-select">
                                                    <option><?=$cak['kol']?></option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="position__price">
                                            <span><?=$cak['kol']*$cake_a->pay?>р.</span>
                                        </div>
                                    </div>
                                </div>
                                <?php
                            }else{
                                foreach ($cak['cake'] as $con){
...
<!--                                            </div>-->
                                        ...
                                        <div class="position__price">
                                            <span><?= $korg+$krem+$nach+$pokr+$ykr?>р.</span>
                                        </div>
                                    </div>
                                </div>
                                <?php
                ...
                <div class="col-md-4 col-sm-5 col-xs-12">
                    <div class="total_wrp">
                        ...
                        <div class="total_wrp__header">
                            <h3>Оформление заказа</h3>
                        </div>

                        <div class="total_wrp__done-block">

                            <div class="done-block__quantity">
                                <div>
                                    4 товара на <span class="color-caral">5800р.</span>
                                </div>
                            </div>


                            <div class="done-block-wrp">
                                <div class="done-block__delivery">
                                    <div class="delivery__header">
                                        Куда доставить?
                                    </div>
                                    <div>
                                        <div class="select">
                                            <span class="placeholder">Выберите район</span>
                                            <ul>
                                                <li data-value="1">Район 1</li>
                                                <li data-value="2">Район 2</li>
                                                <li data-value="3">Район 3</li>
                                                <li data-value="4">Район 4</li>
                                            </ul>
                                            <input type="hidden" name="changeme" />
                                        </div>
                                    </div>
                                    <div>
                                        <input type="text" name="adres" placeholder="Уточните адрес">
                                    </div>
                                    <div class="delivery__ship-price">
                                        <span>За доставку:</span>
                                        <span class="color-caral">200р.</span>
                                    </div>
                                </div>

                                <div class="done-block__recipient">
                                    <div class="recipient__header">Кому?</div>
                                    <div class="">
                                ...
                                <div class="done-block__total">
                                    <span>Итого:</span>
                                    <span class="color-caral">6000р.</span>
                                </div>

                                <div class="done-block__buy">
                                    <a href="#" class="btn btn_one">Оплатить</a>
                                </div>
                            </div>
